...
%%%  D1 =   1: CLASE ( 1 o -1 ) 
%%%  D2 = 268: MUESTRAS
%%% - LOS PRIMEROS  135 REGISTROS SON DE LA CLASE  1
%%% - LOS RESTANTES 133 REGISTROS SON DE LA CLASE -1
T = [ones(1,135) -ones(1,133)];
Q = size(P,2); % Cantidad de muestras

% VALORES INICIALES
n1 = 5;  % Cantidad de neuronas capa oculta.
...
%load('VARIABLES.mat'); % Pesos almacenados.
